        ...
        <AuthenticatedLayout>
            ...
            <div class="w-full px-6 xl:px-28 p-4 rounded">
                ...
                <!-- Create product Container -->
                    <div class="card bg-white p-4 grid grid-cols-1 col-span-2 gap-4">
                ...
                <!-- Label Container -->
                    <div class="card bg-white p-4 grid grid-cols-1 gap-2 h-fit">
                        ...
                        <div class="container create-label-container space-y-2 pt-2 ">
                            <div class="w-fit h-fit">
                                <button @click="()=>{isCreateLabel = !isCreateLabel}" class="
                                     btn shadow-lg text-white
                                      duration-200 delay-100 ease-in-out"
                                      :class="{
                                        'bg-error' : isCreateLabel,
                                        'bg-primary' : !isCreateLabel,
                                      }"
                                    >
                                    ...
                                    <template v-else>
                                        <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" viewBox="0 0 24 24"><path fill="currentColor" d="m8.4 17l3.6-3.6l3.6 3.6l1.4-1.4l-3.6-3.6L17 8.4L15.6 7L12 10.6L8.4 7L7 8.4l3.6 3.6L7 15.6zm3.6 5q-2.075 0-3.9-.788t-3.175-2.137q-1.35-1.35-2.137-3.175T2 12q0-2.075.788-3.9t2.137-3.175q1.35-1.35 3.175-2.137T12 2q2.075 0 3.9.788t3.175 2.137q1.35 1.35 2.138 3.175T22 12q0 2.075-.788 3.9t-2.137 3.175q-1.35 1.35-3.175 2.138T12 22"/></svg>
                                        <span>Batal</span>
                                    </template>
                                </button>
                            </div>
